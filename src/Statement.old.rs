...
import { 
  ...
  isExpressionStatement, ExpressionStatement, Identifier } from "typescript";
...
export abstract class ThisCall {
  ...
  static FindThisCallStrings(body:Node):string[] {
    return [""]
  }
...
export class Argument {
  ...
  get name() {
    return this.element.escapedText as string
  }
